...
├── publikationsbot/     generated probe-set JSONLs (<slug>_combined.jsonl) + querygen intermediates
├── annotation/
...
│                        inputs behind published numbers; see docs/report-deliverables.md
├── eval/                pragmata eval tool outputs; only what pragmata wrote, plus the two
│   │                    *.workspace.json provenance records named in docs/report-deliverables.md
...
│   │                        it <run_id> and overwrites, see docs/synthetic-evaluators.md
