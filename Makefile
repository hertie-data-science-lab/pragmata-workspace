...
.DEFAULT_GOAL := help
.PHONY: help pipeline plan querygen bot combine setup import probe monitor report-tables
...
report-tables: ## Render analysis markdown tables from the latest monitor snapshot
