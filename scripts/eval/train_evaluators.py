...
extra is not in this workspace's lock, see [Synthetic evaluators](../../docs/synthetic-evaluators.md).
...
def _train(eval_api, **kwargs):
    ...
    try:
        ...
        raise SystemExit(
            ...
            "  are in docs/synthetic-evaluators.md."
        ) from exc
...
def train(task: str, threshold_type: str | None = None) -> int:
    ...
    # load-bearing: data/eval/ is pragmata's tool tree by the ownership rule in docs/report-deliverables.md,
