...
| `2026-07-30-eval-report/` | freeze | The canonical data behind every human-annotation and fairness number in the BSt report: the pseudonymised export (41 files) **and** the report CSVs with their `.provenance.json` files and data dictionary (11 files). |
