...
| `2026-07-30-eval-report/` | freeze, **superseded** | The first deliverable set on the pseudonymised export (41 files) plus its report CSVs (11 files). Superseded by `2026-08-06-eval-report/`; retained as an archived record and still verifies. |
