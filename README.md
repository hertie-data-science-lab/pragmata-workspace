...
make eval-predict-inputs       # stage the unlabelled side  (POPULATION=annotated|generated)
...
- [Data transport](docs/data-transport.md) - moving exports, the generated probe set, predictions and checkpoints between the CPU annotation box and the GPU eval box over Azure Blob.
